...
**Katalog-Webseite:** https://selloa.github.io/mmm-data/ — static browse UI built from `source/mmm_catalog.csv`: category view at `/`, flat sortable table at [`/list.html`](https://selloa.github.io/mmm-data/list.html) ([Deploy Site](.github/workflows/deploy-site.yml) on push to `main`).
